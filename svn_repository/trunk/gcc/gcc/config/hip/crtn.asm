...
% Register r30 is the stack-pointer.
sp GREG

% Register r29 is frame-pointer.  It's not supposed to be used in most
% functions.
fp GREG

% r23 is the static chain register; nested functions receive the
